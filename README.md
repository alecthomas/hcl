...
`embed`              | Flattens the fields of a struct into the parent, as opposed to `block` which wraps them in a named block. The field must be a struct or pointer to struct.
